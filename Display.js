...
//var noOfItemsInPage = document.getElementById("tentacles").value;

//var pages = paginate(parseInt(noOfItemsInPage), list);
...
function displayPage(page) {
    header.innerHTML = "Values " + page.start + " to " + page.end + ":";
    ...
    appendChildren(items, page.items.map(function (item) {
        ...
        //li.innerHTML = item;
        li.innerHTML = "<br>" + JSON.stringify(item); 
        return li;
    }));
}
